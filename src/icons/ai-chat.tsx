...
export function RobotDead(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function RobotExcited(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
...
export function RobotConfused(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='1em'
